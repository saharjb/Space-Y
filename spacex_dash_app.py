...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='Launch Site', 
        title='Total succees launches by site')
        return fig
        ...
        fig = px.pie( filtered_df,values=[success_count, failure_count],
                      names=['Class 1', 'Class 0'], 
                      title=f'Total succees launches by site {entered_site} ')
        return fig
    ...
    if entered_site == 'ALL':
       ...
       return fig
        ...
        fig = px.scatter( filtered_df,
                       ...
                       y="class",
                       color="Booster Version Category",
                       title=f"correlation between Payload Mass and Class {entered_site}",
                       labels={"class": "Class", "Payload Mass (kg)": "Payload Mass (kg)"})
        return fig
# Run the app
